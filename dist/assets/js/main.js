...
var lazyImages = document.querySelectorAll("[data-lazyloaded]");
var lazyImageObserver = new IntersectionObserver(onIntersect, {
  root: null,
  //ビューポート
  rootMargin: "200px 0px",
  //0でもpxつける,-50%で要素の中央で発火
  threshold: 0
});

function onIntersect(entries, observer) {
  console.log(entries); //交差検知したもののなかで、isIntersectingがtrueのDOMを色を変える関数に渡す
...
var effectTargets = document.querySelectorAll(".effect-target");
var effectTargetsObserver = new IntersectionObserver(onIntersectEffect, {
  root: null,
  //ビューポート
  rootMargin: "0px 0px",
  //0でもpxつける,-50%で要素の中央で発火
...
if (effectTargets) {
  effectTargets.forEach(function (effectTarget) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _intersectionObserver_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./intersectionObserver.js */ "./src/js/intersectionObserver.js");
/* harmony import */ var _smoothScroll_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./smoothScroll.js */ "./src/js/smoothScroll.js");
...
object_fit_images__WEBPACK_IMPORTED_MODULE_3___default()(); // import Stickyfill from "stickyfilljs"; //polyfill
// const sticky = document.querySelectorAll(".js-sticky");
// Stickyfill.add(sticky);
// ie識別・対策

var agent = window.navigator.userAgent.toLowerCase();
var isIE11 = agent.indexOf('trident/7') !== -1; // メディアクエリ

var breakPointSp = 'max-width:959px';

var isSP = function isSP() {
  if (window.matchMedia("(".concat(breakPointSp, ")"))) {
    return true;
  } else {
    return false;
  }
...
if (document.getElementById('js-totop')) {
  var scrollTopTrigger = function scrollTopTrigger() {
    var trigger = document.getElementById('js-totop');
...
if (isSP) {
  ...
  var hamburgerIcon = function hamburgerIcon() {
    var ariaExpanded = hamburger.getAttribute('aria-expanded');
  ...
  var hamburgerBodyClass = function hamburgerBodyClass() {
  ...
  var spHeaderLinks = document.querySelectorAll('.HeaderSP_nav_list--item .item-link');
  spHeaderLinks.forEach(function (trigger) {
    trigger.addEventListener('click', function () {
      hamburgerIcon();
      hamburgerBodyClass();
    });
...
if (document.getElementById('js-loading')) {
  var loadingFnc = function loadingFnc(delay) {
...
var externalLink = function externalLink() {
  var thisSiteDomain = document.domain;
  var aTags = document.querySelectorAll('a:not([target="_blank"])');
  var array = [];
  ...
  for (var i = 0; i < aTags.length; i++) {
    var aTag = aTags[i];
    var href = aTag.href;
    if (href.indexOf("".concat(thisSiteDomain)) !== -1) continue; //自分のドメインは対象外
...
document.addEventListener('DOMContentLoaded', externalLink, false); //レイヤー開いてるときはbodyスクロール禁止
...
function noScroll() {
  ...
  if (bodyClassList.contains('noscroll')) {
    ...
    var top = bodyStyle.top;
    bodyStyle.position = '';
    bodyStyle.top = '';
    window.scrollTo(0, parseInt(top || '0') * -1);
    bodyClassList.remove('noscroll');
  } else {
    bodyClassList.add('noscroll'); // レイヤーが開いたら、bodyにfixedを付与

    bodyStyle.top = "-".concat(window.scrollY, "px");
...
var scroll = new smooth_scroll__WEBPACK_IMPORTED_MODULE_0___default.a('a[href*="#"]', smoothScrollOption);
